...
import com.onenice.www.ShowViewPagerTransformer;
import com.onenice.www.adapter.ShowBannerAdapter;
import com.onenice.www.adapter.ShowFashionShopAdapter;
import com.onenice.www.adapter.ShowLiveAdapter;
import com.onenice.www.adapter.ShowNewShopAdapter;
...
import com.onenice.www.bean.ShowBannerBean;
...
public class HomeShowFragment extends BaseFragment implements View.OnClickListener,IView {
    ...
    public void success(Object object) {
        ...
        if (object instanceof ShowShopBean){
            ...
            //新品热销
            showNewShopAdapter.setList(showShopBean.getResult().getRxxp().get(0).getCommodityList());
            //魔力时尚
            showFashionShopAdapter.setList(showShopBean.getResult().getMlss().get(0).getCommodityList());
            //品质生活
            showLiveAdapter.setList(showShopBean.getResult().getPzsh().get(0).getCommodityList());
        }
